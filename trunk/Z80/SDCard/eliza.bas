...
105 DIM KEYW$(36),WIN$(7),WOUT$(7),REPL$(112)
110 N1=36:N2=14:N3=112
112 FOR X = 1 TO N1: READ KEYW$(X): NEXT X
114 FOR X = 1 TO N2/2: READ WIN$(X):READ WOUT$(X): NEXT X
116 FOR X = 1 TO N3: READ REPL$(X): NEXT X
130 FOR X=1 TO N1
...
280 REM ***********************************
300 FOR K=1 TO N1
320 FOR L=1 TO LEN (I$)-LEN (KEYW$(K))+1
340 IF MID$(I$,L,LEN(KEYW$(K)))<>KEYW$(K) THEN 350
341 IF K <> 13 THEN 349
342 IF MID$(I$,L,LEN(KEYW$(29)))=KEYW$(29) THEN K = 29
349 F$ = KEYW$(K): GOTO 390
350 NEXT L
360 NEXT K
